...
export const traerTodas = () => async (dispatch) => {
    ...
    try {
        ...
        dispatch({
            type: ERROR,
            payload: 'Ups! Algó salió mal, intente más tarde tareas.',
        });
...
export const agregar = (nueva_tarea) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({
            type: ERROR,
            payload: 'Ups! Algo salió mal al agregar la nueva tarea.',
        });
    }
}
...
export const editar = (tarea_editada) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({
            type: ERROR,
            payload: 'Ups! Algo salió mal al editar la tarea.',
        });
    }
}
...
export const eliminar = (tar_id) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({
            type: ERROR,
            payload: 'Ups! Algo salió mal a la hora e eliminar',
        });
    }
}
